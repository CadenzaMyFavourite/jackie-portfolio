export const projects = [
  {
    ...
    bullets: [
      'Designed and implemented backend services using OO principles and layered architecture.',
  ...
  },
  {
    ...
    bullets: [
      'Built end-to-end AI platform turning raw data into growth strategies.',
  ...
  },
  {
    ...
    bullets: [
      'Scalable backend for processing and judging code submissions.',
  ...
  },
  {
    ...
    bullets: [
      'Developed ML pipeline to forecast stocks beating the S&P500.',
  ...
  },
  {
    ...
    bullets: [
      'Built experimental pipelines to probe model consistency under repeated runs.',
